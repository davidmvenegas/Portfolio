    ...
    return (
        <div className='skills-container'>
            <div className="skills-wrapper">
                <h1 className="skills-header">Proficiencies</h1>
                ...
                <div className="skills-back-box">
                    ...
                    <div className="skills-content">
                        ...
                        <div className="skills-item">
                            ...
                            <h2>Firebase</h2>
                            <p>A highly versatile NoSQL database - I'm also experienced with its Storage and Authentication systems</p>
                        </div>
                    </div>
                </div>
            </div>
            {/* <div className="education-wrapper">
                <h1 className="education-header">Education and Certifications</h1>
